{include file="manager/header.tpl"}
<form action='{$BASE_URL}actions/manager/auth/action_login.php' method='post' class="ink-form block" onsubmit="return SAPO.Ink.FormValidator.validate(this);">
	<fieldset>
    <div class="control">
