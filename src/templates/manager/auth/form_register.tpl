...
<form enctype="multipart/form-data" action='{$BASE_URL}actions/manager/auth/action_register.php' method='post' class="ink-form block" onsubmit="return SAPO.Ink.FormValidator.validate(this);">
  <fieldset>
