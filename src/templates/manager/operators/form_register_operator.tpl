...
<form action='{$BASE_URL}actions/manager/operators/action_register_operator.php' method='post' class="ink-form block" onsubmit="return SAPO.Ink.FormValidator.validate(this);">
  <fieldset>
